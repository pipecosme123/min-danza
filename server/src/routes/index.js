...
// aplica a ellas. teamsRoutes/eventsRoutes son la excepción: están montadas
// en "/" (mezclan rutas /months/:id/... y /teams|/events/:id, ver el
// comentario en esos archivos sobre por qué requireAuth se aplica POR RUTA
// ahí) — por la misma razón, adminLimiter se aplica por ruta DENTRO de esos
// dos archivos, no acá, para no correr como middleware global sobre
// /api/schedule (que ya tiene su propio publicLimiter).
